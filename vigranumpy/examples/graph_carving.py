...
class WsCallsback:
    ...
    def seed1(self, event):
        print "seed 1"
        self.seedNr =1
        print self.seedNr

    def seed2(self, event):
        print "seed 2"
        self.seedNr =2
        print self.seedNr
    ...
    def segment(self, event):
        ...
        ragLabels = vigra.graphs.carvingSegmentation(rag,edgeIndicator,self.seeds,1,bias)
...
axclear = plt.axes([0.4, 0.05, 0.1, 0.075])
axprev = plt.axes([0.5, 0.05, 0.1, 0.075])
axnext1 = plt.axes([0.6, 0.05, 0.1, 0.075])
axnext2 = plt.axes([0.7, 0.05, 0.1, 0.075])
...
seed1 = Button(axnext1, 'seed1')
seed1.on_clicked(callback.seed1)

seed2 = Button(axnext2, 'seed2')
seed2.on_clicked(callback.seed2)
