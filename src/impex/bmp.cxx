...
namespace vigra {
    ...
    struct BmpDecoderImpl
    {
        ...
        void read_colormap( std::ifstream & stream );
        void read_1bit_data( std::ifstream & stream );
        void read_4bit_data( std::ifstream & stream );
        void read_8bit_data( std::ifstream & stream );
        void read_rgb_data( std::ifstream & stream );
    ...
    void BmpDecoderImpl::read_colormap( std::ifstream & stream )
    {
    ...
    void BmpDecoderImpl::read_1bit_data( std::ifstream & stream )
    {
    ...
    void BmpDecoderImpl::read_4bit_data( std::ifstream & stream )
    {
        // these are sizes for the final image
        const unsigned int ncomp = grayscale ? 1 : 3;
        const unsigned int line_size = info_header.width * ncomp;
    ...
    void BmpDecoderImpl::read_8bit_data( std::ifstream & stream )
    {
        // these are sizes for the final image
        const unsigned int ncomp = grayscale ? 1 : 3;
        const unsigned int line_size = info_header.width * ncomp;
    ...
    void BmpDecoderImpl::read_rgb_data( std::ifstream & stream )
    {
        ...
        : scanline(-1)
    {
        ...
        if ( info_header.bit_count != 24 )
            read_colormap(stream);

        // read (and eventually map) the bands
        switch(info_header.bit_count) {
        case 1:
            read_1bit_data(stream);
            break;
        case 4:
            read_4bit_data(stream);
            break;
        case 8:
            read_8bit_data(stream);
            break;
        case 24:
            read_rgb_data(stream);
            break;
        }
    }
