...
<div class="contents">
<h1>(.*)( Class Template Reference| Class Reference)(<br>
<small>
.*</small>
|)</h1>''')
...
#  </div>
#<div class="contents">
#<h1>([^<]+)( Class Template Reference| Class Reference|)()</h1>''')
...
mainHeadingReplacementWithDetailsLink = '''\\1
<div class="contents">
...
mainHeadingReplacementWithoutDetailsLink = '''\\1
<div class="contents">
<table class="main_heading">
<tr>
<td width="100%%">\\2\\4
...
def convertHeadings(text):
    if hasAnchorDetails.search(text):
        ...
        text = detailsHeading2.sub(r'<a name="_details"></a><h2 class="details_section">Detailed Description</h2>', \
                      text, 1)
        mhr = mainHeadingReplacementWithDetailsLink
    else:
        mhr = mainHeadingReplacementWithoutDetailsLink
...
#files = glob.glob('../doc/vigra/classvigra_1_1ImageExportInfo.html')
