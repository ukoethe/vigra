...
inline pair<Diff2D, Accessor>
srcIter(Diff2D const & upperleft, Accessor a)
{
    return pair<Diff2D, Accessor>(upperleft, a);
}

template <class Accessor>
inline pair<Diff2D, Accessor>
maskIter(Diff2D const & upperleft, Accessor a)
{
    return pair<Diff2D, Accessor>(upperleft, a);
}
...
template <class Accessor>
inline pair<Diff2D, Accessor>
destIter(Diff2D const & upperleft, Accessor a)
{
    return pair<Diff2D, Accessor>(upperleft, a);
}
...
inline pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>
srcIter(Diff2D const & upperleft)
{
    return pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>(
                  upperleft,
...
inline pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>
maskIter(Diff2D const & upperleft)
{
    return pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>(
                  upperleft,
                  IteratorTraits<Diff2D>::DefaultAccessor());
...
inline pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>
destIter(Diff2D const & upperleft)
{
    return pair<Diff2D, IteratorTraits<Diff2D>::DefaultAccessor>(
                  upperleft,
                  IteratorTraits<Diff2D>::DefaultAccessor());
