...
void morphoExtinctionValues(Iterator1 srcUpperLeft, Iterator1 srcLowerRight, Accessor1 srca,
...
template<class Iterator1, class Accessor1,
         ...
         class MinmaxFunctor,
         class PriorityFunctor>
void morphoMaskExtinctionValues(Iterator1 srcUpperLeft, Iterator1 srcLowerRight, Accessor1 srca,
                     ...
                     NBTYPE & neighborOffset)
{
    ...
    morphoExtinctionValues(src.first, src.second, src.third,
...
void morphoDynMinima(Image1 & src,
                     Image2 & dest,
                     NBTYPE & neighborOffset)
{
    //vigra::BasicImage::PixelType
    std::vector<typename Image1::value_type> dynamics;
    morphoDynMinima(srcImageRange(src), destImage(dest), dynamics, neighborOffset);
}
                         ...
                         typename Accessor2::value_type maskLabel = 255)
{
    ...
    morphoMaskExtinctionValues(src.first, src.second, src.third,
...
template<class Iterator1, class Accessor1,
             class Iterator2, class Accessor2,
             class NBTYPE>
void morphoMaskDynMinima(Iterator1 srcUpperLeft, Iterator1 srcLowerRight, Accessor1 srca,
                         Iterator2 maskUpperLeft, Accessor2 maska,
                         std::vector<typename Accessor1::value_type> & dynamics,
                         std::vector<typename Accessor1::value_type> & values,
                         NBTYPE & neighborOffset,
                         typename Accessor2::value_type maskLabel = 255)
{
    ...
    morphoMaskExtinctionValues(srcUpperLeft, srcLowerRight, srca,
                               maskUpperLeft, maska,
                               dynamics,
                               values,
                               neighborOffset,
