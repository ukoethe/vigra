...
namespace morpho {
  ...
  void morphoMakeFlooding(Iterator1 srcUpperLeft, Iterator1 srcLowerRight, Accessor1 srca,
...
//    PriorFunctor priority;
             ...
             NBTYPE & neighborOffset)
  {
    ...
    morphoMakeFlooding<LakeArea<vigra::Diff2D, val_type> >
  ...
  void morphoAreaClosing(const Image1 & imin, Image2 & imout, int areaMax, NBTYPE & nbOffset)
  {
  ...
  template<class Image1, class Image2, class NBTYPE>
  void morphoAreaOpening(const Image1 & imin, Image2 & imout, int areaMax, NBTYPE & nbOffset)
  {
                ...
                NBTYPE & neighborOffset)
  {
    ...
    morphoMakeFlooding<LakeDiameter<vigra::Diff2D, val_type> >
             (src.first, src.second, src.third,
                dest.first, dest.second,
                areaMax, neighborOffset,
                IsSmaller<typename Accessor1::value_type, typename Accessor1::value_type>(),
  ...
  template<class Image1, class Image2, class NBTYPE>
  void morphoDiameterClosing(const Image1 & imin, Image2 & imout, int areaMax, NBTYPE & nbOffset)
  {
    morphoDiameterClosing(srcImageRange(imin), destImage(imout), areaMax, nbOffset);
  }
  ...
  template<class Image1, class Image2, class NBTYPE>
  void morphoDiameterOpening(const Image1 & imin, Image2 & imout, int areaMax, NBTYPE & nbOffset)
  {
    morphoDiameterOpening(srcImageRange(imin), destImage(imout), areaMax, nbOffset);
  }
